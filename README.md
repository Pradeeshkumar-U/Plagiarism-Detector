...
project_root -AssignmentChecker.py
submissions/
student1.pdf
student2.pdf
...
...
Install system tools Install Tesseract and add its folder to PATH (e.g., C:\Program Files\Tesseract-OCR). Install Poppler and add C:\poppler\Library\bin to PATH. Restart your terminal after editing PATH.
